...
ABAS = {
    ...
    "REDES_ESPONTANEA": (
        ["data", "rede", "mencoes"],
        [["06/08", "X/Twitter", 26000],
         ["06/08", "Instagram", 12400],
         ["06/08", "TikTok", 6100],
         ["06/08", "Facebook", 2500],
         ["06/08", "YouTube", 1200]],
    ),
...
INSTRUCOES = [
    ...
    ["REDES_ESPONTANEA  quebra das mencoes espontaneas por rede social (grafico abaixo dos Big Numbers)"],
    ...
    ["DIAGNOSTICO ... 'eixo' = globonews (aparece como 'Produtos Globo': g1, GloboNews, TV Globo) ou jornalistas; 'tipo' = funcionou ou nao_funcionou"],
